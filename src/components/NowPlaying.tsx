...
function AnimatedBars() {
  ...
  return (
    <div className="w-auto flex items-center overflow-hidden">
      <span
        id="bar1"
...
export default function NowPlaying() {
  ...
  return (
    <div className="flex flex-row-reverse ml-auto items-center sm:flex-row space-x-0 sm:space-x-2 w-full">
      {data?.songUrl ? (
        <AnimatedBars />
      ) : (
      ...
      <div className="inline-flex flex-col ml-auto sm:flex-row max-w-full truncate">
        {data?.songUrl ? (
          <a
